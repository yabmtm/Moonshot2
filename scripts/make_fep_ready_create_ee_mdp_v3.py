...
def active_site_restraint_info(grofile, residues=['ALA', 'VAL', 'LEU', 'ILE'], cutoff=1.3, verbose=True):
...
def quick_minimize(input_grofile, topfile, ndxfile, output_grofile, workdir, nsteps=1000, babysteps=False, longer=False):
